...
public class ProductsListPage extends BasePage {
  ...
  public ProductsListPage verifyNavigateToPLP(String expectedPageTitle) { // OVO PRAKTICNO RADI ISTO STO I VERIFY
                                                                          // SUCCESSFUL LOGIN KOJI NAM DAJE INFORMACIJU
    String actualPageTitle = readText(pageTitleBy); // DA SMO NA PLP STRANI ALI U OVOM SLUCAJU IMAMO POTVRDU POREDJENJEM
                                                    // IMENA STRANICA
    verifyTextIsTheSame(expectedPageTitle, actualPageTitle);
    return this;
  }
